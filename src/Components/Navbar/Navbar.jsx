...
const Navbar = ({ darkMode, setDarkMode }) => {
	...
	return (
		<nav className='flex justify-between items-center fixed top-0 z-10 w-full py-5 px-8 text-sm font-normal bg-blue-400/55 dark:bg-black/95 text-black dark:text-white/90'>
